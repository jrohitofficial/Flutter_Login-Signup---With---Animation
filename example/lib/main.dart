...
class _LoginScreenState extends State<LoginScreen> {
  ...
  LoginViewTheme get _mobileTheme => LoginViewTheme(
        ...
        backgroundColor:
            Color.fromARGB(255, 0, 78, 17), // const Color(0xFF6666FF),
  ...
  String get _username => language.code == 'NP' ? 'Kullanıcı Adı' : 'Username';

  String get _login => language.code == 'NP' ? 'Giriş Yap' : 'Login';

  String get _signup => language.code == 'NP' ? 'Kayıt Ol' : 'Sign Up';
